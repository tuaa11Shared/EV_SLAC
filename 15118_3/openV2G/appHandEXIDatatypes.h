...
#ifndef APPHANDEXIDATATYPES_HEADER
#define APPHANDEXIDATATYPES_HEADER
...
#define appHandAppProtocolType_ProtocolNamespace_CHARACTERS_SIZE 100 /* XML schema facet maxLength for urn:iso:15118:2:2010:AppProtocol,protocolNamespaceType is 100 */
	typedef struct appHandAppProtocolType {
		/* element: ProtocolNamespace, urn:iso:15118:2:2010:AppProtocol,protocolNamespaceType */
		struct ProtocolNamespace_appHandAppProtocolType {
	...
	typedef enum {
		appHandresponeType_OK_SuccessfulNegotiation = 0,
		appHandresponeType_OK_SuccessfulNegotiationWithMinorDeviation = 1,
		appHandresponeType_Failed_NoNegotiation = 2
	} appHandresponeType;
	...
	struct appHandAnonType_supportedAppProtocolRes {
		...
		appHandresponeType ResponseCode;
		/* element: SchemaID, urn:iso:15118:2:2010:AppProtocol,idType */
		uint8_t SchemaID;
...
#define appHandAnonType_supportedAppProtocolReq_AppProtocol_ARRAY_SIZE 5
	struct appHandAnonType_supportedAppProtocolReq {
		...
		struct AppProtocol_appHandAnonType_supportedAppProtocolReq {
			struct appHandAppProtocolType data_Array[appHandAnonType_supportedAppProtocolReq_AppProtocol_ARRAY_SIZE];
			uint16_t arrayLen;
		} AppProtocol;
	};
	...
	typedef struct appHandEXIDocument {
...
#endif /* APPHANDEXIDATATYPES_HEADER */
