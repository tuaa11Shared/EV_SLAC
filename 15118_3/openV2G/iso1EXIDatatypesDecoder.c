					...
					switch (eventCode) {
						...
						case 1:
							if (iso1SignatureType->Object.arrayLen < iso1SignatureType_Object_ARRAY_SIZE) {
								errn = decode_iso1ObjectType(stream, &iso1SignatureType->Object.data_Array[iso1SignatureType->Object.arrayLen++]);
							}
							else {
					...
					switch (eventCode) {
						case 0:
							if (iso1ServiceParameterListType->ParameterSet.arrayLen < iso1ServiceParameterListType_ParameterSet_ARRAY_SIZE) {
								errn = decode_iso1ParameterSetType(stream, &iso1ServiceParameterListType->ParameterSet.data_Array[iso1ServiceParameterListType->ParameterSet.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						case 0:
							if (iso1ParameterSetType->Parameter.arrayLen < iso1ParameterSetType_Parameter_ARRAY_SIZE) {
								errn = decode_iso1ParameterType(stream, &iso1ParameterSetType->Parameter.data_Array[iso1ParameterSetType->Parameter.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						case 0:
							if (iso1SignedInfoType->Reference.arrayLen < iso1SignedInfoType_Reference_ARRAY_SIZE) {
								errn = decode_iso1ReferenceType(stream, &iso1SignedInfoType->Reference.data_Array[iso1SignedInfoType->Reference.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						case 0:
							if (iso1ServiceListType->Service.arrayLen < iso1ServiceListType_Service_ARRAY_SIZE) {
								errn = decode_iso1ServiceType(stream, &iso1ServiceListType->Service.data_Array[iso1ServiceListType->Service.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						...
						case 1:
							if (iso1ManifestType->Reference.arrayLen < iso1ManifestType_Reference_ARRAY_SIZE) {
								errn = decode_iso1ReferenceType(stream, &iso1ManifestType->Reference.data_Array[iso1ManifestType->Reference.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						case 0:
							if (iso1ConsumptionCostType->Cost.arrayLen < iso1ConsumptionCostType_Cost_ARRAY_SIZE) {
								errn = decode_iso1CostType(stream, &iso1ConsumptionCostType->Cost.data_Array[iso1ConsumptionCostType->Cost.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						case 0:
							if (iso1PMaxScheduleType->PMaxScheduleEntry.arrayLen < iso1PMaxScheduleType_PMaxScheduleEntry_ARRAY_SIZE) {
								errn = decode_iso1PMaxScheduleEntryType(stream, &iso1PMaxScheduleType->PMaxScheduleEntry.data_Array[iso1PMaxScheduleType->PMaxScheduleEntry.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
							...
							if (iso1PaymentOptionListType->PaymentOption.arrayLen < iso1PaymentOptionListType_PaymentOption_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										...
										iso1PaymentOptionListType->PaymentOption.data_Array[iso1PaymentOptionListType->PaymentOption.arrayLen] = (iso1paymentOptionType)uint32;
					...
					switch (eventCode) {
						case 0:
							if (iso1SubCertificatesType->Certificate.arrayLen < iso1SubCertificatesType_Certificate_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeUnsignedInteger16(stream, &iso1SubCertificatesType->Certificate.data_Array[iso1SubCertificatesType->Certificate.arrayLen].bytesLen);
										if (errn == 0) {
											errn = (iso1SubCertificatesType->Certificate.data_Array[iso1SubCertificatesType->Certificate.arrayLen].bytesLen) <= iso1SubCertificatesType_Certificate_BYTES_SIZE ? 0 : EXI_ERROR_OUT_OF_BYTE_BUFFER;
										}
										if (errn == 0) {
											errn = decodeBytes(stream, iso1SubCertificatesType->Certificate.data_Array[iso1SubCertificatesType->Certificate.arrayLen].bytesLen, iso1SubCertificatesType->Certificate.data_Array[iso1SubCertificatesType->Certificate.arrayLen].bytes);
										}
					...
					switch (eventCode) {
						case 0:
							if (iso1ListOfRootCertificateIDsType->RootCertificateID.arrayLen < iso1ListOfRootCertificateIDsType_RootCertificateID_ARRAY_SIZE) {
								errn = decode_iso1X509IssuerSerialType(stream, &iso1ListOfRootCertificateIDsType->RootCertificateID.data_Array[iso1ListOfRootCertificateIDsType->RootCertificateID.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						case 0:
							if (iso1SelectedServiceListType->SelectedService.arrayLen < iso1SelectedServiceListType_SelectedService_ARRAY_SIZE) {
								errn = decode_iso1SelectedServiceType(stream, &iso1SelectedServiceListType->SelectedService.data_Array[iso1SelectedServiceListType->SelectedService.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						...
						case 1:
							if (iso1KeyInfoType->KeyName.arrayLen < iso1KeyInfoType_KeyName_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeUnsignedInteger16(stream, &iso1KeyInfoType->KeyName.data_Array[iso1KeyInfoType->KeyName.arrayLen].charactersLen);
										if (errn == 0) {
											if (iso1KeyInfoType->KeyName.data_Array[iso1KeyInfoType->KeyName.arrayLen].charactersLen >= 2) {
												iso1KeyInfoType->KeyName.data_Array[iso1KeyInfoType->KeyName.arrayLen].charactersLen = (uint16_t)(iso1KeyInfoType->KeyName.data_Array[iso1KeyInfoType->KeyName.arrayLen].charactersLen - 2); /* string table miss */
												errn = decodeCharacters(stream, iso1KeyInfoType->KeyName.data_Array[iso1KeyInfoType->KeyName.arrayLen].charactersLen, iso1KeyInfoType->KeyName.data_Array[iso1KeyInfoType->KeyName.arrayLen].characters, iso1KeyInfoType_KeyName_CHARACTERS_SIZE);
											}
											else {
												/* string table hit */
												errn = EXI_ERROR_STRINGVALUES_NOT_SUPPORTED;
						...
						case 2:
							if (iso1KeyInfoType->KeyValue.arrayLen < iso1KeyInfoType_KeyValue_ARRAY_SIZE) {
								errn = decode_iso1KeyValueType(stream, &iso1KeyInfoType->KeyValue.data_Array[iso1KeyInfoType->KeyValue.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
						...
						case 3:
							if (iso1KeyInfoType->RetrievalMethod.arrayLen < iso1KeyInfoType_RetrievalMethod_ARRAY_SIZE) {
								errn = decode_iso1RetrievalMethodType(stream, &iso1KeyInfoType->RetrievalMethod.data_Array[iso1KeyInfoType->RetrievalMethod.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
						...
						case 4:
							if (iso1KeyInfoType->X509Data.arrayLen < iso1KeyInfoType_X509Data_ARRAY_SIZE) {
								errn = decode_iso1X509DataType(stream, &iso1KeyInfoType->X509Data.data_Array[iso1KeyInfoType->X509Data.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
						...
						case 5:
							if (iso1KeyInfoType->PGPData.arrayLen < iso1KeyInfoType_PGPData_ARRAY_SIZE) {
								errn = decode_iso1PGPDataType(stream, &iso1KeyInfoType->PGPData.data_Array[iso1KeyInfoType->PGPData.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
						...
						case 6:
							if (iso1KeyInfoType->SPKIData.arrayLen < iso1KeyInfoType_SPKIData_ARRAY_SIZE) {
								errn = decode_iso1SPKIDataType(stream, &iso1KeyInfoType->SPKIData.data_Array[iso1KeyInfoType->SPKIData.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
						...
						case 7:
							if (iso1KeyInfoType->MgmtData.arrayLen < iso1KeyInfoType_MgmtData_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeUnsignedInteger16(stream, &iso1KeyInfoType->MgmtData.data_Array[iso1KeyInfoType->MgmtData.arrayLen].charactersLen);
										if (errn == 0) {
											if (iso1KeyInfoType->MgmtData.data_Array[iso1KeyInfoType->MgmtData.arrayLen].charactersLen >= 2) {
												iso1KeyInfoType->MgmtData.data_Array[iso1KeyInfoType->MgmtData.arrayLen].charactersLen = (uint16_t)(iso1KeyInfoType->MgmtData.data_Array[iso1KeyInfoType->MgmtData.arrayLen].charactersLen - 2); /* string table miss */
												errn = decodeCharacters(stream, iso1KeyInfoType->MgmtData.data_Array[iso1KeyInfoType->MgmtData.arrayLen].charactersLen, iso1KeyInfoType->MgmtData.data_Array[iso1KeyInfoType->MgmtData.arrayLen].characters, iso1KeyInfoType_MgmtData_CHARACTERS_SIZE);
											}
											else {
												/* string table hit */
												errn = EXI_ERROR_STRINGVALUES_NOT_SUPPORTED;
					...
					switch (eventCode) {
						case 0:
							if (iso1TransformsType->Transform.arrayLen < iso1TransformsType_Transform_ARRAY_SIZE) {
								errn = decode_iso1TransformType(stream, &iso1TransformsType->Transform.data_Array[iso1TransformsType->Transform.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						case 0:
							if (iso1X509DataType->X509IssuerSerial.arrayLen < iso1X509DataType_X509IssuerSerial_ARRAY_SIZE) {
								errn = decode_iso1X509IssuerSerialType(stream, &iso1X509DataType->X509IssuerSerial.data_Array[iso1X509DataType->X509IssuerSerial.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
						...
						case 1:
							if (iso1X509DataType->X509SKI.arrayLen < iso1X509DataType_X509SKI_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeUnsignedInteger16(stream, &iso1X509DataType->X509SKI.data_Array[iso1X509DataType->X509SKI.arrayLen].bytesLen);
										if (errn == 0) {
											errn = (iso1X509DataType->X509SKI.data_Array[iso1X509DataType->X509SKI.arrayLen].bytesLen) <= iso1X509DataType_X509SKI_BYTES_SIZE ? 0 : EXI_ERROR_OUT_OF_BYTE_BUFFER;
										}
										if (errn == 0) {
											errn = decodeBytes(stream, iso1X509DataType->X509SKI.data_Array[iso1X509DataType->X509SKI.arrayLen].bytesLen, iso1X509DataType->X509SKI.data_Array[iso1X509DataType->X509SKI.arrayLen].bytes);
										}
						...
						case 2:
							if (iso1X509DataType->X509SubjectName.arrayLen < iso1X509DataType_X509SubjectName_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeUnsignedInteger16(stream, &iso1X509DataType->X509SubjectName.data_Array[iso1X509DataType->X509SubjectName.arrayLen].charactersLen);
										if (errn == 0) {
											if (iso1X509DataType->X509SubjectName.data_Array[iso1X509DataType->X509SubjectName.arrayLen].charactersLen >= 2) {
												iso1X509DataType->X509SubjectName.data_Array[iso1X509DataType->X509SubjectName.arrayLen].charactersLen = (uint16_t)(iso1X509DataType->X509SubjectName.data_Array[iso1X509DataType->X509SubjectName.arrayLen].charactersLen - 2); /* string table miss */
												errn = decodeCharacters(stream, iso1X509DataType->X509SubjectName.data_Array[iso1X509DataType->X509SubjectName.arrayLen].charactersLen, iso1X509DataType->X509SubjectName.data_Array[iso1X509DataType->X509SubjectName.arrayLen].characters, iso1X509DataType_X509SubjectName_CHARACTERS_SIZE);
											}
											else {
												/* string table hit */
												errn = EXI_ERROR_STRINGVALUES_NOT_SUPPORTED;
						...
						case 3:
							if (iso1X509DataType->X509Certificate.arrayLen < iso1X509DataType_X509Certificate_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeUnsignedInteger16(stream, &iso1X509DataType->X509Certificate.data_Array[iso1X509DataType->X509Certificate.arrayLen].bytesLen);
										if (errn == 0) {
											errn = (iso1X509DataType->X509Certificate.data_Array[iso1X509DataType->X509Certificate.arrayLen].bytesLen) <= iso1X509DataType_X509Certificate_BYTES_SIZE ? 0 : EXI_ERROR_OUT_OF_BYTE_BUFFER;
										}
										if (errn == 0) {
											errn = decodeBytes(stream, iso1X509DataType->X509Certificate.data_Array[iso1X509DataType->X509Certificate.arrayLen].bytesLen, iso1X509DataType->X509Certificate.data_Array[iso1X509DataType->X509Certificate.arrayLen].bytes);
										}
						...
						case 4:
							if (iso1X509DataType->X509CRL.arrayLen < iso1X509DataType_X509CRL_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeUnsignedInteger16(stream, &iso1X509DataType->X509CRL.data_Array[iso1X509DataType->X509CRL.arrayLen].bytesLen);
										if (errn == 0) {
											errn = (iso1X509DataType->X509CRL.data_Array[iso1X509DataType->X509CRL.arrayLen].bytesLen) <= iso1X509DataType_X509CRL_BYTES_SIZE ? 0 : EXI_ERROR_OUT_OF_BYTE_BUFFER;
										}
										if (errn == 0) {
											errn = decodeBytes(stream, iso1X509DataType->X509CRL.data_Array[iso1X509DataType->X509CRL.arrayLen].bytesLen, iso1X509DataType->X509CRL.data_Array[iso1X509DataType->X509CRL.arrayLen].bytes);
										}
					...
					switch (eventCode) {
						case 0:
							if (iso1SAScheduleListType->SAScheduleTuple.arrayLen < iso1SAScheduleListType_SAScheduleTuple_ARRAY_SIZE) {
								errn = decode_iso1SAScheduleTupleType(stream, &iso1SAScheduleListType->SAScheduleTuple.data_Array[iso1SAScheduleListType->SAScheduleTuple.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						case 0:
							if (iso1ChargingProfileType->ProfileEntry.arrayLen < iso1ChargingProfileType_ProfileEntry_ARRAY_SIZE) {
								errn = decode_iso1ProfileEntryType(stream, &iso1ChargingProfileType->ProfileEntry.data_Array[iso1ChargingProfileType->ProfileEntry.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						case 0:
							if (iso1TransformType->XPath.arrayLen < iso1TransformType_XPath_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeUnsignedInteger16(stream, &iso1TransformType->XPath.data_Array[iso1TransformType->XPath.arrayLen].charactersLen);
										if (errn == 0) {
											if (iso1TransformType->XPath.data_Array[iso1TransformType->XPath.arrayLen].charactersLen >= 2) {
												iso1TransformType->XPath.data_Array[iso1TransformType->XPath.arrayLen].charactersLen = (uint16_t)(iso1TransformType->XPath.data_Array[iso1TransformType->XPath.arrayLen].charactersLen - 2); /* string table miss */
												errn = decodeCharacters(stream, iso1TransformType->XPath.data_Array[iso1TransformType->XPath.arrayLen].charactersLen, iso1TransformType->XPath.data_Array[iso1TransformType->XPath.arrayLen].characters, iso1TransformType_XPath_CHARACTERS_SIZE);
											}
											else {
												/* string table hit */
												errn = EXI_ERROR_STRINGVALUES_NOT_SUPPORTED;
					...
					switch (eventCode) {
						case 0:
							if (iso1SPKIDataType->SPKISexp.arrayLen < iso1SPKIDataType_SPKISexp_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeUnsignedInteger16(stream, &iso1SPKIDataType->SPKISexp.data_Array[iso1SPKIDataType->SPKISexp.arrayLen].bytesLen);
										if (errn == 0) {
											errn = (iso1SPKIDataType->SPKISexp.data_Array[iso1SPKIDataType->SPKISexp.arrayLen].bytesLen) <= iso1SPKIDataType_SPKISexp_BYTES_SIZE ? 0 : EXI_ERROR_OUT_OF_BYTE_BUFFER;
										}
										if (errn == 0) {
											errn = decodeBytes(stream, iso1SPKIDataType->SPKISexp.data_Array[iso1SPKIDataType->SPKISexp.arrayLen].bytesLen, iso1SPKIDataType->SPKISexp.data_Array[iso1SPKIDataType->SPKISexp.arrayLen].bytes);
										}
					...
					switch (eventCode) {
						...
						case 1:
							if (iso1SalesTariffEntryType->ConsumptionCost.arrayLen < iso1SalesTariffEntryType_ConsumptionCost_ARRAY_SIZE) {
								errn = decode_iso1ConsumptionCostType(stream, &iso1SalesTariffEntryType->ConsumptionCost.data_Array[iso1SalesTariffEntryType->ConsumptionCost.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						...
						case 2:
							if (iso1SalesTariffType->SalesTariffEntry.arrayLen < iso1SalesTariffType_SalesTariffEntry_ARRAY_SIZE) {
								errn = decode_iso1SalesTariffEntryType(stream, &iso1SalesTariffType->SalesTariffEntry.data_Array[iso1SalesTariffType->SalesTariffEntry.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
					...
					switch (eventCode) {
						...
						case 1:
							if (iso1SignaturePropertiesType->SignatureProperty.arrayLen < iso1SignaturePropertiesType_SignatureProperty_ARRAY_SIZE) {
								errn = decode_iso1SignaturePropertyType(stream, &iso1SignaturePropertiesType->SignatureProperty.data_Array[iso1SignaturePropertiesType->SignatureProperty.arrayLen++]);
							}
							else {
								errn = EXI_ERROR_OUT_OF_BOUNDS;
							}
						...
						case 0:
							if (iso1SupportedEnergyTransferModeType->EnergyTransferMode.arrayLen < iso1SupportedEnergyTransferModeType_EnergyTransferMode_ARRAY_SIZE) {
								...
								if (errn == 0) {
									if (eventCode == 0) {
										errn = decodeNBitUnsignedInteger(stream, 3, &uint32);
										iso1SupportedEnergyTransferModeType->EnergyTransferMode.data_Array[iso1SupportedEnergyTransferModeType->EnergyTransferMode.arrayLen] = (iso1EnergyTransferModeType)uint32;
