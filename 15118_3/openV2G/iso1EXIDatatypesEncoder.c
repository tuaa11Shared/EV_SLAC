...
int32_t repaireExiDocBuff(iso1EXIDocument* ExiDocBuff) {
	if (ExiDocBuff == NULL)
		return -1;
	else
		memset(ExiDocBuff, 0, sizeof(iso1EXIDocument));
	return 0;
}

int32_t repaireExiStreamBuff(bitstream_t* ExiStreamBuff) {
	if (ExiStreamBuff == NULL)
		return -1;
	else
		memset(ExiStreamBuff, 0, sizeof(bitstream_t));
	return 0;
}
		...
		switch (grammarID) {
			...
			case 8:
				...
				if (iso1SignatureType->KeyInfo_isUsed == 1u) {
					...
					errn = encodeNBitUnsignedInteger(stream, 2, 1);
					if (errn == 0) {
						errn = encode_iso1ObjectType(stream, &iso1SignatureType->Object.data_Array[iso1SignatureType_Object_currArrayIndex++]);
					}
					grammarID = 9;
				}
				else 			if (1 == 1) {
		...
		switch (grammarID) {
			case 29:
				...
				if (iso1ServiceParameterListType_ParameterSet_currArrayIndex < iso1ServiceParameterListType->ParameterSet.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1ParameterSetType(stream, &iso1ServiceParameterListType->ParameterSet.data_Array[iso1ServiceParameterListType_ParameterSet_currArrayIndex++]);
					}
					grammarID = 30;
				}
				else {
		...
		switch (grammarID) {
			...
			case 43:
				...
				if (iso1ParameterSetType_Parameter_currArrayIndex < iso1ParameterSetType->Parameter.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1ParameterType(stream, &iso1ParameterSetType->Parameter.data_Array[iso1ParameterSetType_Parameter_currArrayIndex++]);
					}
					grammarID = 44;
				}
				else {
		...
		switch (grammarID) {
			...
			case 65:
				...
				if (iso1SignedInfoType_Reference_currArrayIndex < iso1SignedInfoType->Reference.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1ReferenceType(stream, &iso1SignedInfoType->Reference.data_Array[iso1SignedInfoType_Reference_currArrayIndex++]);
					}
					grammarID = 66;
				}
				else {
		...
		switch (grammarID) {
			case 69:
				...
				if (iso1ServiceListType_Service_currArrayIndex < iso1ServiceListType->Service.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1ServiceType(stream, &iso1ServiceListType->Service.data_Array[iso1ServiceListType_Service_currArrayIndex++]);
					}
					grammarID = 70;
				}
				else {
		...
		switch (grammarID) {
			case 87:
				...
				if (iso1ManifestType->Id_isUsed == 1u) {
					...
					errn = encodeNBitUnsignedInteger(stream, 2, 1);
					if (errn == 0) {
						errn = encode_iso1ReferenceType(stream, &iso1ManifestType->Reference.data_Array[iso1ManifestType_Reference_currArrayIndex++]);
					}
					grammarID = 66;
				}
				else {
		...
		switch (grammarID) {
			...
			case 105:
				...
				if (iso1ConsumptionCostType_Cost_currArrayIndex < iso1ConsumptionCostType->Cost.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1CostType(stream, &iso1ConsumptionCostType->Cost.data_Array[iso1ConsumptionCostType_Cost_currArrayIndex++]);
					}
					grammarID = 106;
				}
				else {
		...
		switch (grammarID) {
			case 108:
				...
				if (iso1PMaxScheduleType_PMaxScheduleEntry_currArrayIndex < iso1PMaxScheduleType->PMaxScheduleEntry.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1PMaxScheduleEntryType(stream, &iso1PMaxScheduleType->PMaxScheduleEntry.data_Array[iso1PMaxScheduleType_PMaxScheduleEntry_currArrayIndex++]);
					}
					grammarID = 109;
				}
				else {
			...
			case 110:
				...
				if (iso1PaymentOptionListType_PaymentOption_currArrayIndex < iso1PaymentOptionListType->PaymentOption.arrayLen) {
					...
					if (errn == 0) {
						...
						errn = encodeNBitUnsignedInteger(stream, 1, 0);
						if (errn == 0) {
							errn = encodeNBitUnsignedInteger(stream, 1, iso1PaymentOptionListType->PaymentOption.data_Array[iso1PaymentOptionListType_PaymentOption_currArrayIndex++]);
							/* valid EE */
							errn = encodeNBitUnsignedInteger(stream, 1, 0);
						}
					}
			...
			case 140:
				...
				if (iso1SubCertificatesType_Certificate_currArrayIndex < iso1SubCertificatesType->Certificate.arrayLen) {
					...
					if (errn == 0) {
						...
						errn = encodeNBitUnsignedInteger(stream, 1, 0);
						if (errn == 0) {
							errn = encodeUnsignedInteger16(stream, (uint16_t)(iso1SubCertificatesType->Certificate.data_Array[iso1SubCertificatesType_Certificate_currArrayIndex].bytesLen));
							if (errn == 0) {
								errn = encodeBytes(stream, iso1SubCertificatesType->Certificate.data_Array[iso1SubCertificatesType_Certificate_currArrayIndex].bytes, iso1SubCertificatesType->Certificate.data_Array[iso1SubCertificatesType_Certificate_currArrayIndex].bytesLen);
		...
		switch (grammarID) {
			case 158:
				...
				if (iso1ListOfRootCertificateIDsType_RootCertificateID_currArrayIndex < iso1ListOfRootCertificateIDsType->RootCertificateID.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1X509IssuerSerialType(stream, &iso1ListOfRootCertificateIDsType->RootCertificateID.data_Array[iso1ListOfRootCertificateIDsType_RootCertificateID_currArrayIndex++]);
					}
					grammarID = 159;
				}
				else {
		...
		switch (grammarID) {
			case 176:
				...
				if (iso1SelectedServiceListType_SelectedService_currArrayIndex < iso1SelectedServiceListType->SelectedService.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1SelectedServiceType(stream, &iso1SelectedServiceListType->SelectedService.data_Array[iso1SelectedServiceListType_SelectedService_currArrayIndex++]);
					}
					grammarID = 177;
				}
				else {
			...
			case 196:
				...
				if (iso1KeyInfoType->Id_isUsed == 1u) {
					...
					if (errn == 0) {
						...
						if (errn == 0) {
							/* encode string as string table miss (+2 len)*/
							errn = encodeUnsignedInteger16(stream, (uint16_t)(iso1KeyInfoType->KeyName.data_Array[iso1KeyInfoType_KeyName_currArrayIndex].charactersLen + 2));
							if (errn == 0) {
								errn = encodeCharacters(stream, iso1KeyInfoType->KeyName.data_Array[iso1KeyInfoType_KeyName_currArrayIndex].characters, iso1KeyInfoType->KeyName.data_Array[iso1KeyInfoType_KeyName_currArrayIndex].charactersLen);
					...
					if (errn == 0) {
						errn = encode_iso1KeyValueType(stream, &iso1KeyInfoType->KeyValue.data_Array[iso1KeyInfoType_KeyValue_currArrayIndex++]);
					}
					grammarID = 198;
				}
					...
					if (errn == 0) {
						errn = encode_iso1RetrievalMethodType(stream, &iso1KeyInfoType->RetrievalMethod.data_Array[iso1KeyInfoType_RetrievalMethod_currArrayIndex++]);
					}
					grammarID = 198;
				}
					...
					if (errn == 0) {
						errn = encode_iso1X509DataType(stream, &iso1KeyInfoType->X509Data.data_Array[iso1KeyInfoType_X509Data_currArrayIndex++]);
					}
					grammarID = 198;
				}
					...
					if (errn == 0) {
						errn = encode_iso1PGPDataType(stream, &iso1KeyInfoType->PGPData.data_Array[iso1KeyInfoType_PGPData_currArrayIndex++]);
					}
					grammarID = 198;
				}
					...
					if (errn == 0) {
						errn = encode_iso1SPKIDataType(stream, &iso1KeyInfoType->SPKIData.data_Array[iso1KeyInfoType_SPKIData_currArrayIndex++]);
					}
					grammarID = 198;
				}
					...
					if (errn == 0) {
						...
						if (errn == 0) {
							/* encode string as string table miss (+2 len)*/
							errn = encodeUnsignedInteger16(stream, (uint16_t)(iso1KeyInfoType->MgmtData.data_Array[iso1KeyInfoType_MgmtData_currArrayIndex].charactersLen + 2));
							if (errn == 0) {
								errn = encodeCharacters(stream, iso1KeyInfoType->MgmtData.data_Array[iso1KeyInfoType_MgmtData_currArrayIndex].characters, iso1KeyInfoType->MgmtData.data_Array[iso1KeyInfoType_MgmtData_currArrayIndex].charactersLen);
		...
		switch (grammarID) {
			case 200:
				...
				if (iso1TransformsType_Transform_currArrayIndex < iso1TransformsType->Transform.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1TransformType(stream, &iso1TransformsType->Transform.data_Array[iso1TransformsType_Transform_currArrayIndex++]);
					}
					grammarID = 201;
				}
				else {
		...
		switch (grammarID) {
			case 213:
				...
				if (iso1X509DataType_X509IssuerSerial_currArrayIndex < iso1X509DataType->X509IssuerSerial.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 3, 0);
					if (errn == 0) {
						errn = encode_iso1X509IssuerSerialType(stream, &iso1X509DataType->X509IssuerSerial.data_Array[iso1X509DataType_X509IssuerSerial_currArrayIndex++]);
					}
					grammarID = 214;
				}
					...
					if (errn == 0) {
						...
						errn = encodeNBitUnsignedInteger(stream, 1, 0);
						if (errn == 0) {
							errn = encodeUnsignedInteger16(stream, (uint16_t)(iso1X509DataType->X509SKI.data_Array[iso1X509DataType_X509SKI_currArrayIndex].bytesLen));
							if (errn == 0) {
								errn = encodeBytes(stream, iso1X509DataType->X509SKI.data_Array[iso1X509DataType_X509SKI_currArrayIndex].bytes, iso1X509DataType->X509SKI.data_Array[iso1X509DataType_X509SKI_currArrayIndex].bytesLen);
					...
					if (errn == 0) {
						...
						if (errn == 0) {
							/* encode string as string table miss (+2 len)*/
							errn = encodeUnsignedInteger16(stream, (uint16_t)(iso1X509DataType->X509SubjectName.data_Array[iso1X509DataType_X509SubjectName_currArrayIndex].charactersLen + 2));
							if (errn == 0) {
								errn = encodeCharacters(stream, iso1X509DataType->X509SubjectName.data_Array[iso1X509DataType_X509SubjectName_currArrayIndex].characters, iso1X509DataType->X509SubjectName.data_Array[iso1X509DataType_X509SubjectName_currArrayIndex].charactersLen);
					...
					if (errn == 0) {
						...
						errn = encodeNBitUnsignedInteger(stream, 1, 0);
						if (errn == 0) {
							errn = encodeUnsignedInteger16(stream, (uint16_t)(iso1X509DataType->X509Certificate.data_Array[iso1X509DataType_X509Certificate_currArrayIndex].bytesLen));
							if (errn == 0) {
								errn = encodeBytes(stream, iso1X509DataType->X509Certificate.data_Array[iso1X509DataType_X509Certificate_currArrayIndex].bytes, iso1X509DataType->X509Certificate.data_Array[iso1X509DataType_X509Certificate_currArrayIndex].bytesLen);
					...
					if (errn == 0) {
						...
						errn = encodeNBitUnsignedInteger(stream, 1, 0);
						if (errn == 0) {
							errn = encodeUnsignedInteger16(stream, (uint16_t)(iso1X509DataType->X509CRL.data_Array[iso1X509DataType_X509CRL_currArrayIndex].bytesLen));
							if (errn == 0) {
								errn = encodeBytes(stream, iso1X509DataType->X509CRL.data_Array[iso1X509DataType_X509CRL_currArrayIndex].bytes, iso1X509DataType->X509CRL.data_Array[iso1X509DataType_X509CRL_currArrayIndex].bytesLen);
		...
		switch (grammarID) {
			case 217:
				...
				if (iso1SAScheduleListType_SAScheduleTuple_currArrayIndex < iso1SAScheduleListType->SAScheduleTuple.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1SAScheduleTupleType(stream, &iso1SAScheduleListType->SAScheduleTuple.data_Array[iso1SAScheduleListType_SAScheduleTuple_currArrayIndex++]);
					}
					grammarID = 218;
				}
				else {
		...
		switch (grammarID) {
			case 221:
				...
				if (iso1ChargingProfileType_ProfileEntry_currArrayIndex < iso1ChargingProfileType->ProfileEntry.arrayLen) {
					errn = encodeNBitUnsignedInteger(stream, 1, 0);
					if (errn == 0) {
						errn = encode_iso1ProfileEntryType(stream, &iso1ChargingProfileType->ProfileEntry.data_Array[iso1ChargingProfileType_ProfileEntry_currArrayIndex++]);
					}
					grammarID = 222;
				}
				else {
			...
			case 246:
				...
				if (iso1TransformType_XPath_currArrayIndex < iso1TransformType->XPath.arrayLen) {
					...
					if (errn == 0) {
						...
						if (errn == 0) {
							/* encode string as string table miss (+2 len)*/
							errn = encodeUnsignedInteger16(stream, (uint16_t)(iso1TransformType->XPath.data_Array[iso1TransformType_XPath_currArrayIndex].charactersLen + 2));
							if (errn == 0) {
								errn = encodeCharacters(stream, iso1TransformType->XPath.data_Array[iso1TransformType_XPath_currArrayIndex].characters, iso1TransformType->XPath.data_Array[iso1TransformType_XPath_currArrayIndex].charactersLen);
			...
			case 263:
				...
				if (iso1SPKIDataType_SPKISexp_currArrayIndex < iso1SPKIDataType->SPKISexp.arrayLen) {
					...
					if (errn == 0) {
						...
						errn = encodeNBitUnsignedInteger(stream, 1, 0);
						if (errn == 0) {
							errn = encodeUnsignedInteger16(stream, (uint16_t)(iso1SPKIDataType->SPKISexp.data_Array[iso1SPKIDataType_SPKISexp_currArrayIndex].bytesLen));
							if (errn == 0) {
								errn = encodeBytes(stream, iso1SPKIDataType->SPKISexp.data_Array[iso1SPKIDataType_SPKISexp_currArrayIndex].bytes, iso1SPKIDataType->SPKISexp.data_Array[iso1SPKIDataType_SPKISexp_currArrayIndex].bytesLen);
		...
		switch (grammarID) {
			...
			case 284:
				...
				if (iso1SalesTariffEntryType->EPriceLevel_isUsed == 1u) {
					...
					errn = encodeNBitUnsignedInteger(stream, 2, 1);
					if (errn == 0) {
						errn = encode_iso1ConsumptionCostType(stream, &iso1SalesTariffEntryType->ConsumptionCost.data_Array[iso1SalesTariffEntryType_ConsumptionCost_currArrayIndex++]);
					}
					grammarID = 286;
				}
				else 			if (1 == 1) {
		...
		switch (grammarID) {
			...
			case 348:
				...
				if (iso1SalesTariffType->SalesTariffDescription_isUsed == 1u) {
					...
					errn = encodeNBitUnsignedInteger(stream, 2, 2);
					if (errn == 0) {
						errn = encode_iso1SalesTariffEntryType(stream, &iso1SalesTariffType->SalesTariffEntry.data_Array[iso1SalesTariffType_SalesTariffEntry_currArrayIndex++]);
					}
					grammarID = 351;
				}
				else {
		...
		switch (grammarID) {
			case 354:
				...
				if (iso1SignaturePropertiesType->Id_isUsed == 1u) {
					...
					errn = encodeNBitUnsignedInteger(stream, 2, 1);
					if (errn == 0) {
						errn = encode_iso1SignaturePropertyType(stream, &iso1SignaturePropertiesType->SignatureProperty.data_Array[iso1SignaturePropertiesType_SignatureProperty_currArrayIndex++]);
					}
					grammarID = 356;
				}
				else {
			...
			case 357:
				...
				if (iso1SupportedEnergyTransferModeType_EnergyTransferMode_currArrayIndex < iso1SupportedEnergyTransferModeType->EnergyTransferMode.arrayLen) {
					...
					if (errn == 0) {
						...
						errn = encodeNBitUnsignedInteger(stream, 1, 0);
						if (errn == 0) {
							errn = encodeNBitUnsignedInteger(stream, 3, iso1SupportedEnergyTransferModeType->EnergyTransferMode.data_Array[iso1SupportedEnergyTransferModeType_EnergyTransferMode_currArrayIndex++]);
							/* valid EE */
							errn = encodeNBitUnsignedInteger(stream, 1, 0);
						}
					}
