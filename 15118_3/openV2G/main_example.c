...
int appHandshakeHandler(bitstream_t* iStream, bitstream_t* oStream) {
	...
	for (i = 0;i < exiDoc.supportedAppProtocolReq.AppProtocol.arrayLen;i++) {
		...
		printASCIIString(exiDoc.supportedAppProtocolReq.AppProtocol.data_Array[i].ProtocolNamespace.characters, exiDoc.supportedAppProtocolReq.AppProtocol.data_Array[i].ProtocolNamespace.charactersLen);
		printf("\t\tVersion=%d.%d\n", exiDoc.supportedAppProtocolReq.AppProtocol.data_Array[i].VersionNumberMajor, exiDoc.supportedAppProtocolReq.AppProtocol.data_Array[i].VersionNumberMinor);
		printf("\t\tSchemaID=%d\n", exiDoc.supportedAppProtocolReq.AppProtocol.data_Array[i].SchemaID);
		printf("\t\tPriority=%d\n", exiDoc.supportedAppProtocolReq.AppProtocol.data_Array[i].Priority);
	}
	...
	appHandResp.supportedAppProtocolRes.ResponseCode = appHandresponeType_OK_SuccessfulNegotiation;
	appHandResp.supportedAppProtocolRes.SchemaID = exiDoc.supportedAppProtocolReq.AppProtocol.data_Array[0].SchemaID; /* signal the protocol by the provided schema id*/
...
struct appHandEXIDocument appHandshake() {
	...
	memcpy(stream1.data, buffer1, sizeof(buffer1));
	stream1.pos = pos1;

	stream2.size = BUFFER_SIZE;
	memcpy(stream1.data, buffer2, sizeof(buffer2));
	stream2.pos = pos2;
	...
	handshake.supportedAppProtocolReq.AppProtocol.data_Array[0].ProtocolNamespace.charactersLen =
		writeStringToEXIString(ns0, handshake.supportedAppProtocolReq.AppProtocol.data_Array[0].ProtocolNamespace.characters);
	handshake.supportedAppProtocolReq.AppProtocol.data_Array[0].SchemaID = 1;
	handshake.supportedAppProtocolReq.AppProtocol.data_Array[0].VersionNumberMajor = 1;
	handshake.supportedAppProtocolReq.AppProtocol.data_Array[0].VersionNumberMinor = 0;
	handshake.supportedAppProtocolReq.AppProtocol.data_Array[0].Priority = 1;

	handshake.supportedAppProtocolReq.AppProtocol.data_Array[1].ProtocolNamespace.charactersLen =
		writeStringToEXIString(ns1, handshake.supportedAppProtocolReq.AppProtocol.data_Array[1].ProtocolNamespace.characters);
	handshake.supportedAppProtocolReq.AppProtocol.data_Array[1].SchemaID = 2;
	handshake.supportedAppProtocolReq.AppProtocol.data_Array[1].VersionNumberMajor = 1;
	handshake.supportedAppProtocolReq.AppProtocol.data_Array[1].VersionNumberMinor = 0;
	handshake.supportedAppProtocolReq.AppProtocol.data_Array[1].Priority = 2;
	...
	if (errn == 0) {
		...
		if ((errn = read_v2gtpHeader(stream2.data, &payloadLengthDec)) == 0) {
			stream2.pos = V2GTP_HEADER_LENGTH;
			
			if (decode_appHandExiDocument(&stream2, &handshakeResp) == 0) {
				printf("EV side: Response of the EVSE \n");
				if (handshakeResp.supportedAppProtocolRes.ResponseCode == appHandresponeType_OK_SuccessfulNegotiation) {
...
void printEVSEStatus2(struct iso2EVSEStatusType* status) {
	printf("\tEVSEStatus:\n");
...
int serialize2EXI2Stream(struct iso2EXIDocument* exiIn, bitstream_t* stream) {
	int errn;
...
int deserialize2Stream2EXI(bitstream_t* streamIn, struct iso2EXIDocument* exi) {
	int errn;
...
int sessionSetup2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int serviceDiscovery2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
	int i;
	...
	if (exiIn->V2G_Message.Body.ServiceDiscoveryReq.SupportedServiceIDs_isUsed) {
		for (i = 0;i < exiIn->V2G_Message.Body.ServiceDiscoveryReq.SupportedServiceIDs.ServiceID.arrayLen; i++) {
			printf("\t\tSupportedServiceID=%d\n", exiIn->V2G_Message.Body.ServiceDiscoveryReq.SupportedServiceIDs.ServiceID.data_Array[i]);
		}
	}
	...
	exiOut->V2G_Message.Body.ServiceDiscoveryRes.PaymentOptionList.PaymentOption.data_Array[0] = iso2paymentOptionType_ExternalPayment; /* EVSE handles the payment */
	exiOut->V2G_Message.Body.ServiceDiscoveryRes.PaymentOptionList.PaymentOption.data_Array[1] = iso2paymentOptionType_Contract;
	...
	exiOut->V2G_Message.Body.ServiceDiscoveryRes.EnergyTransferServiceList.Service.data_Array[0].ServiceID = 1; /* ID of the charge service */
	exiOut->V2G_Message.Body.ServiceDiscoveryRes.EnergyTransferServiceList.Service.data_Array[0].FreeService = 1;
...
int serviceDetail2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
	...
	/* Parameter Set 1*/
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].ParameterSetID = 1;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.arrayLen = 2;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].Name.charactersLen = 8;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].Name.characters[0] = 'P';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].Name.characters[1] = 'r';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].Name.characters[2] = 'o';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].Name.characters[3] = 't';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].Name.characters[4] = 'o';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].Name.characters[5] = 'c';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].Name.characters[6] = 'o';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].Name.characters[7] = 'l';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].intValue = 15119;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[0].intValue_isUsed = 1u;

	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].Name.charactersLen = 4;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].Name.characters[0] = 'N';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].Name.characters[1] = 'a';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].Name.characters[2] = 'm';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].Name.characters[3] = 'e';

	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].stringValue_isUsed = 1u;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].stringValue.charactersLen = 3;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].stringValue.characters[0] = 'V';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].stringValue.characters[1] = '2';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[0].Parameter.data_Array[1].stringValue.characters[2] = 'G';

	/* Parameter Set 2 */
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].ParameterSetID = 2;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.arrayLen = 1;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].Name.charactersLen = 7;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].Name.characters[0] = 'C';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].Name.characters[1] = 'h';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].Name.characters[2] = 'a';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].Name.characters[3] = 'n';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].Name.characters[4] = 'n';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].Name.characters[5] = 'e';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].Name.characters[6] = 'l';
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].physicalValue_isUsed = 1u;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].physicalValue.Value = 1234;

	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].physicalValue.Exponent = 1;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].physicalValue.Value = 2;
...
int paymentServiceSelection2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
	int i;
	...
	if (exiIn->V2G_Message.Body.PaymentServiceSelectionReq.SelectedVASList_isUsed) {
		for (i = 0; i < exiIn->V2G_Message.Body.PaymentServiceSelectionReq.SelectedVASList.SelectedService.arrayLen;i++) {
			printf("\t\t ServiceID=%d\n", exiIn->V2G_Message.Body.PaymentServiceSelectionReq.SelectedVASList.SelectedService.data_Array[i].ServiceID);
			printf("\t\t ParameterSetID=%d\n", exiIn->V2G_Message.Body.PaymentServiceSelectionReq.SelectedVASList.SelectedService.data_Array[i].ParameterSetID);
		}
	}
...
int paymentDetails2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
	...
	printf("\t\t SubCertificate 1=%c%c\n", exiIn->V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[0].bytes[0], exiIn->V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[0].bytes[1]);
	printf("\t\t SubCertificate 2=%c%c\n", exiIn->V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[1].bytes[0], exiIn->V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[1].bytes[1]);
...
int authorization2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int chargeParameterDiscovery2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int powerDelivery2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int chargingStatus2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int meteringReceipt2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int sessionStop2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int cableCheck2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int preCharge2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int create_response_message2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
...
int request_response2(struct iso2EXIDocument* exiIn, struct iso2EXIDocument* exiOut) {
	int errn;
...
int charging2() {
	...
	exiIn.V2G_Message.Body.ServiceDiscoveryReq.SupportedServiceIDs.ServiceID.data_Array[0] = iso2serviceCategoryType_Internet;
	...
	if (errn == 0) {
		...
		if (exiOut.V2G_Message.Body.ServiceDiscoveryRes_isUsed) {
			...
			if(serviceDiscoveryRes.PaymentOptionList.PaymentOption.data_Array[1] == v2gpaymentOptionType_Contract) {
			...
			if(serviceDiscoveryRes.ChargeService.SupportedEnergyTransferMode.EnergyTransferMode.data_Array[0] == v2gEnergyTransferModeType_DC_combo_core) {
				printf("\t EnergyTransferMode=AC_single_DC_core\n");
			}
			if(serviceDiscoveryRes.ChargeService.SupportedEnergyTransferMode.EnergyTransferMode.data_Array[1] == v2gEnergyTransferModeType_AC_single_phase_core) {
			...
			{
				printf("\n\t\t ServiceID=%d\n",	serviceDiscoveryRes.ServiceList.Service.data_Array[i].ServiceID);
				printf("\t\t ServiceName=");
				printASCIIString(serviceDiscoveryRes.ServiceList.Service.data_Array[i].ServiceName.characters, exiOut.V2G_Message.Body.ServiceDiscoveryRes.ServiceList.Service.data_Array[i].ServiceName.charactersLen );
				if(serviceDiscoveryRes.ServiceList.Service.data_Array[i].ServiceCategory == v2gserviceCategoryType_Internet) {
					printf("\t\t ServiceCategory=Internet\n");
				}
				if(serviceDiscoveryRes.ServiceList.Service.data_Array[i].FreeService==1) {
		...
		if (exiOut.V2G_Message.Body.ServiceDetailRes_isUsed) {
			...
			if (serviceDetailRes.ServiceParameterList_isUsed) {
				...
				for (i = 0; i < serviceDetailRes.ServiceParameterList.ParameterSet.arrayLen; i++) {
					printf("\t\tServiceSetID=%d\n", serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].ParameterSetID);
					printf("\t\tParameters=%d\n", serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.arrayLen);

					for (j = 0; j < serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.arrayLen; j++) {
						printf("\t\t\t %d: ParameterName=", j + 1);
						printASCIIString(serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].Name.characters, exiOut.V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].Name.charactersLen);

						/*if(serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].shortValue_isUsed == 1u) {
							printf("\t\t\t %d: StringValue=", j+1);
							printASCIIString(serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].stringValue.characters, serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].stringValue.charactersLen);
						} else if(serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].intValue_isUsed == 1u) {
							printf("\t\t\t %d: IntValue=%d\n", j+1, serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].intValue);
						} else if(serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].physicalValue_isUsed == 1u) {
							printf("\t\t\t %d: PhysicalValue=%d (%d)\n",  j+1, serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].physicalValue.Value, serviceDetailRes.ServiceParameterList.ParameterSet.data_Array[i].Parameter.data_Array[j].physicalValue.Multiplier);
						}*/
					}
				}
			}
	...
	exiIn.V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[0].bytes[0] = 'S';
	exiIn.V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[0].bytes[1] = 'u';
	exiIn.V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[0].bytesLen = 2;
	exiIn.V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[1].bytes[0] = 'S';
	exiIn.V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[1].bytes[1] = 'u';
	exiIn.V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[1].bytes[2] = '2';
	exiIn.V2G_Message.Body.PaymentDetailsReq.ContractSignatureCertChain.SubCertificates.Certificate.data_Array[1].bytesLen = 3;
	...
	exiIn.V2G_Message.Body.PowerDeliveryReq.SAScheduleTupleID = exiOut.V2G_Message.Body.ChargeParameterDiscoveryRes.SAScheduleList.SAScheduleTuple.data_Array[0].SAScheduleTupleID;
...
struct iso1EXIDocument deserialize1Stream2EXI_M(uint8_t* buff, uint8_t len) {
	...
	uint32_t payloadLength;
	size_t pos = 0;
	iso1EXIDocument exiDoc;
	bitstream_t stream;


	memcpy(stream.data, buff, len);
	stream.pos = pos;
	stream.size = len;

	if ((errn = read_v2gtpHeader(buff, &payloadLength)) == 0) {
		stream.pos += V2GTP_HEADER_LENGTH;
		errn = decode_iso1ExiDocument(&stream, &exiDoc);
	}
	return exiDoc;
}
...
uint16_t deserialize1Stream2EXI_MT(void) {
	...
	memcpy(stream.data, buffer, sizeof(buffer));

	stream.pos = 0;
	stream.size = 4096;

	if ((errn = read_v2gtpHeader(stream.data, &payloadLength)) == 0) {
		stream.pos += V2GTP_HEADER_LENGTH;
		errn = decode_iso1ExiDocument(&stream, &exiDoc);
	}
	return exiDoc.SessionSetupReq.EVCCID.bytesLen;
}

int sessionSetup1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
	printf("EVSE side: sessionSetup called\n");
	printf("\tReceived data:\n");
	printf("\tHeader SessionID=");
	printBinaryArray(exiIn->V2G_Message.Header.SessionID.bytes, exiIn->V2G_Message.Header.SessionID.bytesLen);
...
int serviceDetail1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
	...
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].physicalValue.Multiplier = 1;
	exiOut->V2G_Message.Body.ServiceDetailRes.ServiceParameterList.ParameterSet.data_Array[1].Parameter.data_Array[0].physicalValue.Value = 2;
...
int powerDelivery1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
	printf("EVSE side: powerDelivery called\n");
	printf("\tReceived data:\n");
...
int chargingStatus1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
...
int meteringReceipt1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
...
int sessionStop1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
...
int cableCheck1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
...
int preCharge1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
...
int create_response_message1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
	int errn = ERROR_UNEXPECTED_REQUEST_MESSAGE;
...
/* Adapt this to your system setup! */
/* In this situation EV and EVSE is the same party */
int request_response1(struct iso1EXIDocument* exiIn, struct iso1EXIDocument* exiOut) {
	int errn;
...
int xmldsig_test() {
	...
	*/
	...
	init_xmldsigSignedInfoType(&exiXMLDSIG_SI.SignedInfo);
	{
		...
		/* "#ID1" */
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].URI_isUsed = 1;
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].URI.charactersLen = 4;
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].URI.characters[0] = '#';
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].URI.characters[1] = 'I';
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].URI.characters[2] = 'D';
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].URI.characters[3] = '1';
		/* "http://www.w3.org/TR/canonical-exi/" */
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].Transforms_isUsed = 1;
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].Transforms.Transform.arrayLen = 1;
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].Transforms.Transform.data_Array[0].Algorithm.charactersLen = 35;
		strncpy(exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].Transforms.Transform.data_Array[0].Algorithm.characters, arrayCanonicalEXI, 35); /* Will copy 35 characters from arrayCanonicalEXI to characters */
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].Transforms.Transform.data_Array[0].XPath.arrayLen = 0;

		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].DigestMethod.Algorithm.charactersLen = 39;
		strncpy(exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].DigestMethod.Algorithm.characters, arrayxmlencSHA256, 39);

		/* "0bXgPQBlvuVrMXmERTBR61TKGPwOCRYXT4s8d6mPSqk=" --> 16 Bytes 536F6D652052616E646F6D2044617461 */
		exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].DigestValue.bytesLen = 32;
		memcpy(exiXMLDSIG_SI.SignedInfo.Reference.data_Array[0].DigestValue.bytes, digestValue, 32);
	}
...
int main_example(int argc, char* argv []) {
	int errn = 0;
	(void)deserialize1Stream2EXI_MT();
