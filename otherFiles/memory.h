 ...
 *--------------------------------------------------------------------*/
uint32_t hexencode (char * memory, uint32_t extent, char const * string);
...
uint32_t hexdecode (void const * memory, size_t extent, char buffer [], size_t length);
uint32_t decdecode (void const * memory, size_t extent, char buffer [], size_t length);
...
uint32_t bytespec (char const * string, void * memory, size_t extent);
uint32_t dataspec (char const * string, void * memory, size_t extent);
uint32_t ipv4spec (char const * string, void * memory);
/*====================================================================*
 *   memory input functions;
 *--------------------------------------------------------------------*/
uint32_t hexload (void * memory, size_t extent, FILE *fp);
/*====================================================================*
