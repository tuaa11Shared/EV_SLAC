/*====================================================================*
 *
 *   endian.h - integer byte_t order declarations and definitions;
 *
...
#       else
#               error "Undefined host byte_t order (2)."
#       endif
...
#               define HTOLE64(x) __bswap_64(x)
#       else
#               error "Undefined host byte_t order vxworks."
#       endif
#else
#error "Undefined host byte_t order (1)."
#endif
/*====================================================================*
